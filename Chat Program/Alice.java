...
public class Alice {
    ...
    ServerSocket ssSocket;   //serversocket used to lisen on port number 8000
    ...
    public static void main(String[] args) throws Exception {
        ...
        //System.out.println("Using port number " + sPort);
        Writer w = new Writer();
        w.start();
    ...
    void run()
    {
        try{
            ...
            ssSocket = new ServerSocket(sPort);
            //Wait for connection
            //System.out.println("Waiting for connection");
            //accept a connection from the client
            connection = ssSocket.accept();
            //System.out.println();
    ...
    private static class Writer extends Thread {
        ...
        public void run() {
            try{
                ...
                System.out.println("Connected to Bob in port " + pNum);
